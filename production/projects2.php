                      ...
                      <tbody>
                        <?php 
                          ...
                          $row = mysqli_fetch_assoc($select);
                            ...
                            {
                              $query1 = "select * from rejected where username = '$username'";
                              ...
                              $row = mysqli_fetch_assoc($select1);
                                ...
                                if($fname == null)
                                {
                                $query2 = "select * from applications where username = '$username'";
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="#" class="btn btn-success btn-xs"> <?php echo $status; ?> </a>
